            ...
            <div className={style.contentWrapper}>
                <div className={style.copyContainer}>
                    <div className={style.title}>
                        Discover, Collect and Sell Amazings NFTs.
                    </div>
                ...
                <div className={style.cardContainer}>
                    <img className="rounded-t-lg" src="https://lh3.googleusercontent.com/soR6JAuB0k-X3Az9G8-NJG9Cfoc4kyfgPUCYVtp6Ker9QQSHg9UQA52eFduoL_v_E5dHnnaB3LtZjBIAZdH6p5e2rLOm7aVm6eVoMg=s550"
                    alt="" 
                    />
                <div className={style.infoContainer}>
                    <img 
                        className="h-[2.25rem] rounded-full"
                        src="https://storage.opensea.io/static/promocards/screen-promocard.png" alt=""
                    />
                    <div className={style.author}>
                        <div className={style.name}>KIM </div>
                        <a 
                            className="text-[#1868b]"
