...
const Collections = () => {
  ...
  // https://eth-rinkeby.alchemyapi.io/v2/NexuFe6j-GHLUphyXSQpXZBNl2ZfPSGT
  ...
  const marketPlaceModule = useMemo(() => {
    ...
    return sdk.getMarketplaceModule(
      '0xf2720058cdb6a7b8a77DA00625d0Af97c49F6D6f'
    )
  }, [provider])
  ...
  const fetchCollectionData = async (sanityClient = client) => {
    const query = `*[_type == "marketItems" && contractAddress == "${collectionId}" ] {
            ...
            cratedBy,
            contractAddress,
            "creator": createdBy->userName,title,floorPrice,
            "allOwners": owners[]->,
            description
          }`
